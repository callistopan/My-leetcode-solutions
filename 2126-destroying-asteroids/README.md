...
<pre style="position: relative;"><strong>Input:</strong> mass = 10, asteroids = [3,9,19,5,21]
...
<pre style="position: relative;"><strong>Input:</strong> mass = 5, asteroids = [4,9,23,4]
<strong>Output:</strong> false
<strong>Explanation:</strong> 
The planet cannot ever gain enough mass to destroy the asteroid with a mass of 23.
After the planet destroys the other asteroids, it will have a mass of 5 + 4 + 9 + 4 = 22.
This is less than 23, so a collision would not destroy the last asteroid.<div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>
