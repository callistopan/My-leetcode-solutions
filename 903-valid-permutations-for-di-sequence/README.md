<h2><a href="https://leetcode.com/problems/valid-permutations-for-di-sequence/">903. Valid Permutations for DI Sequence</a></h2><h3>Hard</h3><hr><div><p>You are given a string <code>s</code> of length <code>n</code> where <code>s[i]</code> is either:</p>
...
<pre style="position: relative;"><strong>Input:</strong> s = "DID"
...
<pre style="position: relative;"><strong>Input:</strong> s = "D"
